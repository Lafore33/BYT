...
public class ProvidedServiceMasterAssociationTest {
    ...
    void setUp() {
        ...
        master1 = Worker.createMaster("Mike", "Johnson", "555555555", LocalDate.of(1980, 3, 20), 5);
        master2 = Worker.createMaster("Sarah", "Williams", "666666666", LocalDate.of(1985, 6, 15), 4);
        master3 = Worker.createMaster("Tom", "Davis", "777777777", LocalDate.of(1982, 9, 25), 3);
        masterNotSpecialized = Worker.createMaster("Bob", "Wilson", "888888888", LocalDate.of(1988, 12, 1), 2);
