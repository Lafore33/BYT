...
class ReceptionistTest {
    ...
    void constructorSetsValuesCorrectly(){
        ...
        assertEquals(phoneNumber, receptionist.getWorker().getPhoneNumber(), "Incorrect phone number set in constructor");
        assertEquals(birthDate, receptionist.getWorker().getBirthDate(), "Incorrect birth date set in constructor");
